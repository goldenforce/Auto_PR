...
select 'IDMV000021',NULL,'00004180',NULL,sysdate(),'GS:PSG:P72','N','Fixed Income SOI','FISOI','Fixed Income SOI','','',NULL,NULL,NULL,NULL,NULL,'ACTIVE',NULL,NULL,'P72' from DUAL where not exists (select 'X' from ft_t_idmv where  fld_id='00004180' and intrnl_dmn_val_id='IDMV000021');
