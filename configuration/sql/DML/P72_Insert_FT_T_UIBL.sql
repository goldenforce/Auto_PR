...
INSERT INTO ft_t_uibl
(business_label_txt, business_label_nme, cntry_cde, screen_attr_path_desc, business_label_desc, created_usr_id, prod_nme, created_tms)
select 'Composite BB Global', 'BB Global', 'en', 'Bonds.CountrysPrimaryExchange.MktLstCountryCompositeBBGlobal', '', 'anastasia.veremeenko@point72.com', NULL, NULL
...
INSERT INTO ft_t_uibl
(business_label_txt, business_label_nme, cntry_cde, screen_attr_path_desc, business_label_desc, created_usr_id, prod_nme, created_tms)
select 'Convertible Type', 'Common Stock Ticker Exchange', 'en', 'Bonds.BondFeatures.ConvertibleType', '', 'anastasia.veremeenko@point72.com', NULL, NULL
  where not exists (select '1' from ft_t_uibl where business_label_txt = 'Convertible Type' and screen_attr_path_desc = 'Bonds.BondFeatures.ConvertibleType');
INSERT INTO ft_t_uibl
(business_label_txt, business_label_nme, cntry_cde, screen_attr_path_desc, business_label_desc, created_usr_id, prod_nme, created_tms)
...
INSERT INTO ft_t_uibl
(business_label_txt, business_label_nme, cntry_cde, screen_attr_path_desc, business_label_desc, created_usr_id, prod_nme, created_tms)
select 'Pay-In-Kind-Coupons', 'Payment In Kind Cate', 'en', 'Bonds.InstrumentStatistic.P72PaymentInKindCoupons', '', 'anastasia.veremeenko@point72.com', NULL, NULL
