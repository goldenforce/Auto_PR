...
<MappingDef type="MSF" version="1.0">
  <Options>
    ...
    <Option key="RCode"/>
    <Option key="LastChangedTms">2022-03-07 at 11:24:51 IST</Option>
  ...
  <Input vendorType="VARIABLE">
    ...
    <Layout>
      ...
      <field decimals="0" desc="" excludedNullIdentifiers="" ident="StarMine Security ID" length="255" mandatory="false" mapable="true" match="false" multiple="false" name="StarMineSecurityID" pattern="" pos="0" readonly="false" type="String"/>
      <field decimals="0" desc="" excludedNullIdentifiers="" ident="Security Country Code" length="255" mandatory="false" mapable="true" match="false" multiple="false" name="SecurityCountryCode" pattern="" pos="0" readonly="false" type="String"/>
    </Layout>
  </Input>
  <Output>
    <Options>
    ...
    <OutputDef>
      <Node messageformat="GSREF" name="STREET_REF" type="message">
        ...
        <condition><![CDATA[if (OneHasValue(StarMineSecurityID))
	return "STREET_REF";
else
	return "";]]></condition>
        ...
        <Node name="HEADER" type="element">
          ...
          <Node name="MAIN_ENTITY_ID" type="element">
            <Node name="VALUE" type="attribute">
              <expr><![CDATA[return StarMineSecurityID;]]></expr>
            </Node>
          </Node>
          <Node name="MAIN_ENTITY_ID_CTXT_TYP" type="element">
            <Node name="VALUE" type="attribute">
              <expr><![CDATA[return "STARMINE";]]></expr>
            </Node>
          </Node>
	...
	return StoreString("ISIN", Select("", "", "select iss_id from ft_t_isid where  end_tms  is null and id_ctxt_typ  = 'ISIN' and instr_id  in (select instr_id from ft_t_isid where  id_ctxt_typ in ('SEDOL') and iss_id = :1 and end_tms is null)", CheckIdentifier("SEDOL", SEDOL), "", "", "", ""));
else
	return "";]]></expr>
        </Execute>
	...
	return "";]]></condition>
        ...
        <Node displayName="SEDOL" name="IssueIdentifier" type="segment">
          <condition><![CDATA[if ((StrLen(SEDOL) == 6) && !Strcmp(SecurityCountryCode, "US"))
	return "IssueIdentifier";
else
	return "";]]></condition>
          <Node name="ACTION" type="attribute">
          ...
          <Node name="ISSID" type="element">
            <Node name="VALUE" type="attribute">
              <expr><![CDATA[if (StrLen(SEDOL) == 6)
	return CheckIdentifier("SEDOL", SEDOL);
else
	return "";]]></expr>
            </Node>
          </Node>
        ...
        <Node displayName="CUSIP" name="IssueIdentifier" type="segment">
          <condition><![CDATA[if ((StrLen(CUSIP) == 8) && Strcmp(SecurityCountryCode, "US"))
	return "IssueIdentifier";
else
	return "";]]></condition>
          <Node name="ACTION" type="attribute">
          ...
          <Node name="IDCTXTTYP" type="element">
            <Node name="VALUE" type="attribute">
              <expr><![CDATA[if (OneHasValue(CUSIP) && !IsAlpha(CUSIP, 1, 1))
	return "CUSIP";
else
	return "CINS";]]></expr>
            </Node>
          ...
          <Node name="ISSID" type="element">
            <Node name="VALUE" type="attribute">
              <expr><![CDATA[if (StrLen(CUSIP) == 8)
	return CheckIdentifier(If(!IsAlpha(CUSIP, 1, 1), "CUSIP", "CINS"), CUSIP);
else
	return "";]]></expr>
            </Node>
          </Node>
        ...
        <Node name="IssueGeoUnit" type="segment">
          <condition><![CDATA[if (OneHasValue(SecurityCountryCode))
	return "IssueGeoUnit";
else
	return "";]]></condition>
          <Node name="ACTION" type="attribute">
          ...
          <Node name="GeographicUnit" type="segment">
            ...
            <Node displayName="STARMINE" name="GeographicUnitIdentifier" type="segment">
		...
		Strcat(SecurityCountryCode, "|DATASRCID|P72"));]]></expr>
              </Node>
              ...
              <Node name="GEOUNITID" type="element">
                <Node name="VALUE" type="attribute">
                  <expr><![CDATA[return SecurityCountryCode;]]></expr>
                </Node>
              </Node>
        ...
        <Node displayName="STARMINE" name="IssueIdentifier" type="segment">
          <condition><![CDATA[if (OneHasValue(StarMineSecurityID))
	return "IssueIdentifier";
else
	return "";]]></condition>
