...
<MappingDef type="MSF" version="1.0">
  <Options>
    ...
    <Option key="RCode"/>
    <Option key="LastChangedTms">2022-03-07 at 11:22:05 IST</Option>
  ...
  <Input vendorType="VARIABLE">
    ...
    <Layout>
      ...
      <field decimals="0" desc="" excludedNullIdentifiers="" ident="EXCHG" length="255" mandatory="false" mapable="true" match="false" multiple="false" name="EXCHG" pattern="" pos="0" readonly="false" type="String"/>
  ...
  <Output>
	...
	return "";
else if (AllHaveValue(GVKEY, IID))
	return "STREET_REF";
else
	return "";]]></condition>
        ...
        <Node name="HEADER" type="element">
          ...
          <Node name="MSGCLASSIFICATION" type="element">
            <Node name="VALUE" type="attribute">
              <expr><![CDATA[return "CMPSTATSECF";]]></expr>
            </Node>
          </Node>
